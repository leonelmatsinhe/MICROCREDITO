...
#   ./scripts/deploy.sh feature/xyz  # pull de branch específica
#
set -euo pipefail
...
echo "=========================================="
echo "  DEPLOY — MBR Microcrédito"
echo "  Branch: $BRANCH"
echo "=========================================="

# 1. Pull do GitHub
echo ""
echo "[1/5] A obter alterações do GitHub..."
git fetch origin
git checkout "$BRANCH"
...
echo ""
echo "[2/5] A verificar dependências..."
