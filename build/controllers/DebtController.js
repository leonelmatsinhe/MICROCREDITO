    ...
    if (newDebt != null) {
        ...
        try {
            const amortization = amortisationId
                ? yield AmortizationLoanModel_1.AmorizationLoanModel.findByPk(amortisationId, {
                    attributes: ["id", "dueDate"],
                })
                : null;
            yield (0, SmsGatewayService_1.enqueueLateInterestSms)({
                ...
                dueDate: (amortization === null || amortization === void 0 ? void 0 : amortization.dueDate) || null,
            });
        }
        catch (smsError) {
