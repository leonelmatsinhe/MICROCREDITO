<template>
  <div class="q-pa-md">
    ...
    <div class="row items-center q-mb-md">
      <div class="col">
        <div class="text-h5 text-weight-bold">Histórico do Sistema</div>
        <div class="text-caption text-grey-5">Registo completo de acções e movimentos</div>
      </div>
      <div class="col-auto">
...
const columns = [
  { name: 'datetime', label: 'Data/Hora', field: 'createdAt', align: 'left', sortable: true },
...
function formatTime(dateStr) {
  if (!dateStr) return ''
  const d = new Date(dateStr)
  return d.toLocaleTimeString('pt-MZ', { hour: '2-digit', minute: '2-digit', second: '2-digit' })
}
